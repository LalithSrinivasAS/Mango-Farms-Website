...
function Buyproduct() {
  ...
  const handleQuantityChange = (quantity) => {
    const updatedProduct = { ...cartProduct, quantity };
          ...
          <div className='cart-item'>
            <div className='cart-container'>
              <table className="cart-table">
                ...
                <tbody>
                  <tr>
                    <td rowSpan={2}><img className="cart-image" src={cartProduct.imgurl1} alt={cartProduct.name} /></td>
                    ...
                    <td>₹{cartProduct.MRP * (cartProduct.quantity || 1)}</td>
                  </tr>
                  <tr>
